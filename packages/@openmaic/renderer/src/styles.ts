...
/* RTL: when the containing page sets dir="rtl", ensure Arabic text is
   start-aligned (= right in RTL) and not forced left. Browsers usually
   handle this, but explicit LTR rules in parent frameworks (Tailwind,
   prose plugins) can override — this puts us back in the right place. */
[dir="rtl"] .slide-renderer-prose,
[dir="rtl"] .slide-renderer-prose * {
  text-align: start;
  direction: rtl;
  unicode-bidi: embed;
